...
*/
import { IoCreate, BiBoxArrowInRight, MdLogout, MdLogin, PrSpinner, FaFileUpload } from "oh-vue-icons/icons";

addIcons(IoCreate, BiBoxArrowInRight, MdLogout, MdLogin, PrSpinner, FaFileUpload);
